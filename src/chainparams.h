...
public:
    ...
    int Bitwin24BadBlockTime() const { return nBitwin24BadBlockTime; }
    int Bitwin24BadBlocknBits() const { return nBitwin24BadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nBitwin24BadBlockTime;
    unsigned int nBitwin24BadBlocknBits;
