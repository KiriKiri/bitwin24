...
// Copyright (c) 2016-2019 The Bitwin24 developers
...
public:
    ...
    bool WriteZBWISeed(const uint256& hashSeed, const std::vector<unsigned char>& seed);
    bool ReadZBWISeed(const uint256& hashSeed, std::vector<unsigned char>& seed);
