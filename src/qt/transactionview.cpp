 ...
 */
    ...
    typeWidget->addItem(tr("Received BWI from zBWI"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBWI"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBWI));
