 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Bitwin24 (http://www.bitwin24.org),
...
bool AppInit(int argc, char* argv[])
{
    ...
    try {
        ...
        if (fCommandLine) {
            fprintf(stderr, "Error: There is no RPC client functionality in bitwin24d anymore. Use the bitwin24-cli utility instead.\n");
            exit(1);
        }
#ifndef WIN32
