...
1. Clone the Bitwin24 Core source code:

        git clone https://github.com/bitwin24-project/bitwin24
        cd bitwin24
...
Bitwin24 Core is now available at `./src/bitwin24d`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/Bitwin24"

    touch "/Users/${USER}/Library/Application Support/Bitwin24/bitwin24.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Bitwin24/bitwin24.conf"

The first time you run bitwin24d, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/bitwin24d -daemon # Starts the bitwin24 daemon.
    ./src/bitwin24-cli --help # Outputs a list of command-line options.
    ./src/bitwin24-cli help # Outputs a list of RPC commands when the daemon is running.
